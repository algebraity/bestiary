...
void registerBuiltins(void) {
    ...
    registerCommand("isSquare", 1, bi_issquare);
    registerCommand("issym", 1, bi_issym);
    registerCommand("isSym", 1, bi_issym);
    registerCommand("isSymmetric", 1, bi_issym);
    registerCommand("issymmetric", 1, bi_issym);
    registerCommand("isantisym", 1, bi_isantisym);
    registerCommand("isAntisym", 1, bi_isantisym);
    registerCommand("isAntisymmetric", 1, bi_isantisym);
    registerCommand("isantisymmetric", 1, bi_isantisym);
    registerCommand("isAntrisymmetric", 1, bi_isantisym);
    registerCommand("isantrisymmetric", 1, bi_isantisym);
    registerCommand("isunitary", 1, bi_isunitary);
    registerCommand("isUnitary", 1, bi_isunitary);
    registerCommand("isorthog", 1, bi_isorthog);
    registerCommand("isOrthog", 1, bi_isorthog);
    ...
    registerCommand("fnorm", 1, bi_fnorm);
    registerCommand("frobeniusNorm", 1, bi_fnorm);
    registerCommand("frobeniusnorm", 1, bi_fnorm);
    registerCommand("det", 1, bi_det);
    registerCommand("determinant", 1, bi_det);
    ...
    registerCommand("disp", 2, bi_displacement);
    registerCommand("averageVelocity", 3, bi_averageVelocity);
    registerCommand("averagevelocity", 3, bi_averageVelocity);
    registerCommand("avgVelocity", 3, bi_averageVelocity);
    registerCommand("avgvelocity", 3, bi_averageVelocity);
    registerCommand("avgVel", 3, bi_averageVelocity);
    registerCommand("avgvel", 3, bi_averageVelocity);
    registerCommand("avgv", 3, bi_averageVelocity);
    registerCommand("averageAcceleration", 4, bi_averageAcceleration);
    registerCommand("averageacceleration", 4, bi_averageAcceleration);
    registerCommand("avgAccel", 4, bi_averageAcceleration);
    registerCommand("avgaccel", 4, bi_averageAcceleration);
    registerCommand("avga", 4, bi_averageAcceleration);
    registerCommand("velocityAtTime", 3, bi_velocityAtTime);
    registerCommand("velocityattime", 3, bi_velocityAtTime);
    registerCommand("velAtTime", 3, bi_velocityAtTime);
    registerCommand("velattime", 3, bi_velocityAtTime);
    registerCommand("positionAtTime", 4, bi_positionAtTime);
    registerCommand("positionattime", 4, bi_positionAtTime);
    registerCommand("posAtTime", 4, bi_positionAtTime);
    registerCommand("posattime", 4, bi_positionAtTime);
    registerCommand("speedAtPosition", 4, bi_speedAtPosition);
    registerCommand("speedatposition", 4, bi_speedAtPosition);
    registerCommand("speedAtP", 4, bi_speedAtPosition);
    registerCommand("speedatp", 4, bi_speedAtPosition);
    registerCommand("velocityAtPosition", 4, bi_velocityAtPosition);
    registerCommand("velocityatposition", 4, bi_velocityAtPosition);
    registerCommand("velocityAtPos", 4, bi_velocityAtPosition);
    registerCommand("velocityatpos", 4, bi_velocityAtPosition);
    registerCommand("velAtPosition", 4, bi_velocityAtPosition);
    registerCommand("velatposition", 4, bi_velocityAtPosition);
    registerCommand("velAtPos", 4, bi_velocityAtPosition);
    registerCommand("velatpos", 4, bi_velocityAtPosition);
    registerCommand("projectileInfo", 3, bi_projectileInfo);
    registerCommand("projectileinfo", 3, bi_projectileInfo);
    registerCommand("projInfo", 3, bi_projectileInfo);
    registerCommand("projinfo", 3, bi_projectileInfo);
    registerCommand("projectile", 3, bi_projectileInfo);
    registerCommand("centripetalAcceleration", 2, bi_centripetalAcceleration);
    registerCommand("centripetalacceleration", 2, bi_centripetalAcceleration);
    registerCommand("centripetalAccel", 2, bi_centripetalAcceleration);
    registerCommand("centripetalaccel", 2, bi_centripetalAcceleration);
    registerCommand("angularVelocity", 2, bi_angularVelocity);
    registerCommand("angularvelocity", 2, bi_angularVelocity);
    registerCommand("angularVel", 2, bi_angularVelocity);
    registerCommand("angularvel", 2, bi_angularVelocity);
    registerCommand("angularv", 2, bi_angularVelocity);
    registerCommand("netForce", 1, bi_netForce);
    registerCommand("netforce", 1, bi_netForce);
    registerCommand("accelerationFromForce", 1, bi_accelerationFromForce);
    registerCommand("accelerationfromforce", 1, bi_accelerationFromForce);
    registerCommand("accelFromForce", 1, bi_accelerationFromForce);
    registerCommand("accelfromforce", 1, bi_accelerationFromForce);
    registerCommand("gravityForce", 1, bi_gravityForce);
    registerCommand("gravityforce", 1, bi_gravityForce);
    registerCommand("gravForce", 1, bi_gravityForce);
    registerCommand("gravforce", 1, bi_gravityForce);
    registerCommand("forceGrav", 1, bi_gravityForce);
    registerCommand("forcegrav", 1, bi_gravityForce);
    registerCommand("normalForce", 2, bi_normalForce);
    registerCommand("normalforce", 2, bi_normalForce);
    registerCommand("frictionForce", 3, bi_frictionForce);
    registerCommand("frictionforce", 3, bi_frictionForce);
    registerCommand("friction", 3, bi_frictionForce);
    registerCommand("momentum", 1, bi_momentum);
    registerCommand("kineticEnergy", 1, bi_kineticEnergy);
    registerCommand("kineticenergy", 1, bi_kineticEnergy);
    registerCommand("KE", 1, bi_kineticEnergy);
    registerCommand("ke", 1, bi_kineticEnergy);
    registerCommand("gravPotentialEnergy", 2, bi_gravPotentialEnergy);
    registerCommand("gravpotentialenergy", 2, bi_gravPotentialEnergy);
    registerCommand("gravPE", 2, bi_gravPotentialEnergy);
    registerCommand("gravpe", 2, bi_gravPotentialEnergy);
    registerCommand("springPotentialEnergy", 2, bi_springPotentialEnergy);
    registerCommand("springpotentialenergy", 2, bi_springPotentialEnergy);
    registerCommand("springPE", 2, bi_springPotentialEnergy);
    registerCommand("springpe", 2, bi_springPotentialEnergy);
    ...
    registerCommand("centerofmass", -1, bi_centerOfMass);
    registerCommand("com", -1, bi_centerOfMass);
    registerCommand("centerOfMassVelocity", -1, bi_centerOfMassVelocity);
    registerCommand("centerofmassvelocity", -1, bi_centerOfMassVelocity);
    registerCommand("comVel", -1, bi_centerOfMassVelocity);
    registerCommand("comvel", -1, bi_centerOfMassVelocity);
    registerCommand("comv", -1, bi_centerOfMassVelocity);
    ...
    registerCommand("momentofinertiapoint", 2, bi_moiPoint);
    registerCommand("momentOfIneriaPoint", 2, bi_moiPoint);
    registerCommand("momentofineriapoint", 2, bi_moiPoint);
    registerCommand("moiPoint", 2, bi_moiPoint);
    registerCommand("moipoint", 2, bi_moiPoint);
    registerCommand("momentOfInertiaRod", 2, bi_moiRod);
    registerCommand("momentofinertiarod", 2, bi_moiRod);
    registerCommand("momentOfIneriaRod", 2, bi_moiRod);
    registerCommand("momentofineriarod", 2, bi_moiRod);
    registerCommand("moiRod", 2, bi_moiRod);
    registerCommand("moirod", 2, bi_moiRod);
    registerCommand("momentOfInertiaDisk", 2, bi_moiDisk);
    registerCommand("momentofinertiadisk", 2, bi_moiDisk);
    registerCommand("momentOfIneriaDisk", 2, bi_moiDisk);
    registerCommand("momentofineriadisk", 2, bi_moiDisk);
    registerCommand("moiDisk", 2, bi_moiDisk);
    registerCommand("moidisk", 2, bi_moiDisk);
    registerCommand("parallelAxis", 3, bi_parallelAxis);
    registerCommand("parallelaxis", 3, bi_parallelAxis);
    registerCommand("parallelAxisTheorem", 3, bi_parallelAxis);
    registerCommand("parallelaxistheorem", 3, bi_parallelAxis);
    registerCommand("torque", 2, bi_torque);
    registerCommand("angularMomentum", 2, bi_angularMomentumCmd);
    registerCommand("angularmomentum", 2, bi_angularMomentumCmd);
    registerCommand("angularMoment", 2, bi_angularMomentumCmd);
    registerCommand("angularmoment", 2, bi_angularMomentumCmd);
    registerCommand("angularMom", 2, bi_angularMomentumCmd);
    registerCommand("angularmom", 2, bi_angularMomentumCmd);
    registerCommand("angmom", 2, bi_angularMomentumCmd);
    registerCommand("rotationalKineticEnergy", 2, bi_rotationalKineticEnergy);
    registerCommand("rotationalkineticenergy", 2, bi_rotationalKineticEnergy);
    registerCommand("rotationalKE", 2, bi_rotationalKineticEnergy);
    registerCommand("rotationalke", 2, bi_rotationalKineticEnergy);
    registerCommand("rotKE", 2, bi_rotationalKineticEnergy);
    registerCommand("rotke", 2, bi_rotationalKineticEnergy);
    registerCommand("angularAccelerationFromTorque", 2, bi_angularAccelerationFromTorque);
    registerCommand("angularaccelerationfromtorque", 2, bi_angularAccelerationFromTorque);
    registerCommand("angularAccelFromTorque", 2, bi_angularAccelerationFromTorque);
    registerCommand("angularaccelfromtorque", 2, bi_angularAccelerationFromTorque);
    registerCommand("angAccelFromTorque", 2, bi_angularAccelerationFromTorque);
    registerCommand("angaccelfromtorque", 2, bi_angularAccelerationFromTorque);
    registerCommand("ZnGroup", 1, bi_ZnGroup);
    registerCommand("zngroup", 1, bi_ZnGroup);
    registerCommand("ZnProductGroup", 1, bi_ZnProductGroup);
    registerCommand("znproductgroup", 1, bi_ZnProductGroup);
    registerCommand("ZnProdGroup", 1, bi_ZnProductGroup);
    registerCommand("znprodgroup", 1, bi_ZnProductGroup);
    registerCommand("SymmetricGroup", 1, bi_SymmetricGroup);
    registerCommand("symmetricgroup", 1, bi_SymmetricGroup);
    registerCommand("SnGroup", 1, bi_SymmetricGroup);
    registerCommand("sngroup", 1, bi_SymmetricGroup);
    registerCommand("Sn", 1, bi_SymmetricGroup);
    registerCommand("sn", 1, bi_SymmetricGroup);
    registerCommand("AlternatingGroup", 1, bi_AlternatingGroup);
    registerCommand("alternatinggroup", 1, bi_AlternatingGroup);
    registerCommand("AnGroup", 1, bi_AlternatingGroup);
    registerCommand("angroup", 1, bi_AlternatingGroup);
    registerCommand("An", 1, bi_AlternatingGroup);
    registerCommand("an", 1, bi_AlternatingGroup);
    registerCommand("dihedralGroup", 1, bi_DihedralGroup);
    registerCommand("dihedralgroup", 1, bi_DihedralGroup);
    registerCommand("DnGroup", 1, bi_DihedralGroup);
    registerCommand("dngroup", 1, bi_DihedralGroup);
    ...
    registerCommand("znproductring", 1, bi_ZnProductRing);
    registerCommand("ZnProdRing", 1, bi_ZnProductRing);
    registerCommand("znprodring", 1, bi_ZnProductRing);
    registerCommand("primeFiniteField", 1, bi_primeFiniteField);
    registerCommand("primefinitefield", 1, bi_primeFiniteField);
    registerCommand("primeField", 1, bi_primeFiniteField);
    registerCommand("primefield", 1, bi_primeFiniteField);
    registerCommand("primeFF", 1, bi_primeFiniteField);
    registerCommand("primeff", 1, bi_primeFiniteField);
    registerCommand("finiteField", 2, bi_finiteField);
    registerCommand("finitefield", 2, bi_finiteField);
    registerCommand("FF", 2, bi_finiteField);
    registerCommand("ff", 2, bi_finiteField);
    registerCommand("quaternionGroup", 0, bi_quaternionGroup);
    registerCommand("quaterniongroup", 0, bi_quaternionGroup);
    ...
    registerCommand("groupelementconjugate", 2, bi_groupElementConjugate_cmd);
    registerCommand("groupConjugate", 2, bi_groupElementConjugate_cmd);
    registerCommand("groupconjugate", 2, bi_groupElementConjugate_cmd);
    registerCommand("groupConj", 2, bi_groupElementConjugate_cmd);
    registerCommand("groupconj", 2, bi_groupElementConjugate_cmd);
    registerCommand("groupCommutator", 2, bi_groupCommutator_cmd);
    registerCommand("groupcommutator", 2, bi_groupCommutator_cmd);
    registerCommand("commutator", 2, bi_groupCommutator_cmd);
    registerCommand("elementOrderGroup", 1, bi_elementOrderGroup);
    registerCommand("elementordergroup", 1, bi_elementOrderGroup);
    registerCommand("orderGroup", 1, bi_elementOrderGroup);
    registerCommand("ordergroup", 1, bi_elementOrderGroup);
    registerCommand("additiveOrder", 1, bi_additiveOrder_cmd);
    registerCommand("additiveorder", 1, bi_additiveOrder_cmd);
    registerCommand("addOrder", 1, bi_additiveOrder_cmd);
    registerCommand("addorder", 1, bi_additiveOrder_cmd);
    registerCommand("multiplicativeOrder", 1, bi_multiplicativeOrder_cmd);
    registerCommand("multiplicativeorder", 1, bi_multiplicativeOrder_cmd);
    registerCommand("multOrder", 1, bi_multiplicativeOrder_cmd);
    registerCommand("multorder", 1, bi_multiplicativeOrder_cmd);
    ...
    registerCommand("groupidentity", 1, bi_groupIdentity_cmd);
    registerCommand("groupIdent", 1, bi_groupIdentity_cmd);
    registerCommand("groupident", 1, bi_groupIdentity_cmd);
    registerCommand("isAddIdentity", 2, bi_isAddIdentity_cmd);
    registerCommand("isaddidentity", 2, bi_isAddIdentity_cmd);
    registerCommand("isAddIdent", 2, bi_isAddIdentity_cmd);
    registerCommand("isaddident", 2, bi_isAddIdentity_cmd);
    registerCommand("isMultIdentity", 2, bi_isMultIdentity_cmd);
    registerCommand("ismultidentity", 2, bi_isMultIdentity_cmd);
    registerCommand("isMultIdent", 2, bi_isMultIdentity_cmd);
    registerCommand("ismultident", 2, bi_isMultIdentity_cmd);
    registerCommand("hasMultIdentity", 1, bi_hasMultIdentity_cmd);
    registerCommand("hasmultidentity", 1, bi_hasMultIdentity_cmd);
    registerCommand("hasMultIdent", 1, bi_hasMultIdentity_cmd);
    registerCommand("hasmultident", 1, bi_hasMultIdentity_cmd);
    registerCommand("elementsCommute", 2, bi_elementsCommute_cmd);
    registerCommand("elementscommute", 2, bi_elementsCommute_cmd);
    registerCommand("commute", 2, bi_elementsCommute_cmd);
    ...
    registerCommand("trivialgroup", 0, bi_trivialGroup_cmd);
    registerCommand("zeroGroup", 0, bi_trivialGroup_cmd);
    registerCommand("zerogroup", 0, bi_trivialGroup_cmd);
    registerCommand("trivialRing", 0, bi_trivialRing_cmd);
    registerCommand("trivialring", 0, bi_trivialRing_cmd);
    registerCommand("zeroRing", 0, bi_trivialRing_cmd);
    registerCommand("zeroring", 0, bi_trivialRing_cmd);
    ...
    registerCommand("conjugacyclass", 1, bi_conjugacyClass_cmd);
    registerCommand("conjClass", 1, bi_conjugacyClass_cmd);
    registerCommand("conjclass", 1, bi_conjugacyClass_cmd);
    ...
    registerCommand("commutatorsubgroup", 1, bi_commutatorSubgroup_cmd);
    registerCommand("groupAbelianization", 1, bi_groupAbelianization_cmd);
    registerCommand("groupabelianization", 1, bi_groupAbelianization_cmd);
    ...
    registerCommand("iscyclicgroup", 1, bi_isCyclicGroup_cmd);
    registerCommand("isCyclic", 1, bi_isCyclicGroup_cmd);
    registerCommand("iscyclic", 1, bi_isCyclicGroup_cmd);
    ...
    registerCommand("generatescyclicgroup", 2, bi_generatesCyclicGroup_cmd);
    registerCommand("gensCyclicGroup", 2, bi_generatesCyclicGroup_cmd);
    registerCommand("genscyclicgroup", 2, bi_generatesCyclicGroup_cmd);
    registerCommand("generatesCyclicSubgroup", 2, bi_generatesCyclicSubgroup_cmd);
    registerCommand("generatescyclicsubgroup", 2, bi_generatesCyclicSubgroup_cmd);
    registerCommand("gensCyclicSubgroup", 2, bi_generatesCyclicSubgroup_cmd);
    registerCommand("genscyclicsubgroup", 2, bi_generatesCyclicSubgroup_cmd);
    ...
    registerCommand("iszerodivisor", 1, bi_isZeroDivisor_cmd);
    registerCommand("isZD", 1, bi_isZeroDivisor_cmd);
    registerCommand("iszd", 1, bi_isZeroDivisor_cmd);
    registerCommand("hasZeroDivisors", 1, bi_hasZeroDivisors_cmd);
    registerCommand("haszerodivisors", 1, bi_hasZeroDivisors_cmd);
    registerCommand("hasZeroDivisor", 1, bi_hasZeroDivisors_cmd);
    registerCommand("haszerodivisor", 1, bi_hasZeroDivisors_cmd);
    registerCommand("hasZD", 1, bi_hasZeroDivisors_cmd);
    registerCommand("haszd", 1, bi_hasZeroDivisors_cmd);
    registerCommand("isIntegralDomain", 1, bi_isIntegralDomain_cmd);
    registerCommand("isintegraldomain", 1, bi_isIntegralDomain_cmd);
    registerCommand("isID", 1, bi_isIntegralDomain_cmd);
    registerCommand("isid", 1, bi_isIntegralDomain_cmd);
    registerCommand("isDivisionRing", 1, bi_isDivisionRing_cmd);
    registerCommand("isdivisionring", 1, bi_isDivisionRing_cmd);
    registerCommand("isDR", 1, bi_isDivisionRing_cmd);
    registerCommand("isdr", 1, bi_isDivisionRing_cmd);
    registerCommand("isField", 1, bi_isField_cmd);
    registerCommand("isfield", 1, bi_isField_cmd);
    registerCommand("isSubset", 2, bi_isSubset);
    registerCommand("intersect", 2, bi_cap);
    registerCommand("intersection", 2, bi_cap);
    registerCommand("union", 2, bi_cup);
    registerCommand("diam", 1, bi_diam);
    registerCommand("diameter", 1, bi_diam);
    registerCommand("dc", 1, bi_dc);
    registerCommand("doublingconstant", 1, bi_dc);
    ...
    registerCommand("mdscard", 1, bi_mdsCard);
    registerCommand("isArithmeticProgression", 1, bi_isAP);
    registerCommand("isAP", 1, bi_isAP);
    registerCommand("isap", 1, bi_isAP);
    registerCommand("isGeometricProgression", 1, bi_isGP);
    registerCommand("isGP", 1, bi_isGP);
    registerCommand("isgp", 1, bi_isGP);
    registerCommand("ruzsaDistance", 2, bi_rd);
    registerCommand("rd", 2, bi_rd);
    registerCommand("ruzsaDistancePositive", 2, bi_rdpos);
    registerCommand("ruzscaDistancePositive", 2, bi_rdpos);
    registerCommand("rdpos", 2, bi_rdpos);
    registerCommand("rdp", 2, bi_rdpos);
