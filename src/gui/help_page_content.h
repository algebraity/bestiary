...
static constexpr Command kCommands[] = {
    ...
    HELP_CMD("roots", 1, Beast::Neko, "Finds roots of a supported expression in x, using exact degree <= 4 formulae for real or complex polynomials before numerical fallback.", "Symbol/numeric/NEKO expression", "List of exact formula expressions for degree <= 4 polynomials, otherwise Decimal or Complex roots"),
